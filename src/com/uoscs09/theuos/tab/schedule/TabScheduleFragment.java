...
public class TabScheduleFragment extends
		AbsDrawableProgressFragment<ScheduleItemWrapper> {
	TextView mTextView;
	...
	public ScheduleItemWrapper call() throws Exception {
		return (ScheduleItemWrapper) ParseFactory
				.create(ParseFactory.What.Schedule,
						HttpRequest.getBody(URL, StringUtil.ENCODE_EUC_KR), 0)
				.parse().get(0);
	}
